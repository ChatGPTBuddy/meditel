...
const BackofficeSection: React.FC = () => {
  const features = [
    { 
      ...
      title: "KB Management", 
      description: "Regional vector databases for reliable and fast context search." 
    },
    { 
      icon: <MessageSquare className="h-8 w-8 text-green-500" />, 
      title: "Conversations", 
      description: "Monitor real-time sessions across different channels." 
    },
    { 
      icon: <PhoneForwarded className="h-8 w-8 text-purple-500" />, 
      title: "Live Transfer", 
      description: "Intercom-like system to take over conversations directly." 
    },
    { 
      icon: <LineChart className="h-8 w-8 text-red-500" />, 
      title: "Analytics", 
      description: "Monitor message counts, conversation times, and other metrics." 
    },
    { 
      icon: <Layout className="h-8 w-8 text-yellow-500" />, 
      title: "UI Engine", 
      description: "Display buttons, carousels, images, and interactive UI elements." 
    },
    { 
      icon: <Palette className="h-8 w-8 text-indigo-500" />, 
      title: "Sleek Themes", 
      description: "Choose brand colors, light/dark mode, and ready-made palettes." 
    },
    { 
      icon: <Smartphone className="h-8 w-8 text-pink-500" />, 
      title: "Channels", 
      description: "Support for Web, WhatsApp, Discord, Google Chat, and more." 
    },
    { 
      icon: <Rocket className="h-8 w-8 text-orange-500" />, 
      title: "Docs & APIs", 
      description: "Integrate with other services via REST API and helper functions." 
    },
    { 
      icon: <Settings className="h-8 w-8 text-teal-500" />, 
      title: "Custom Branding", 
      description: "Fully customize with your logo and custom domain." 
    },
  ];
    ...
    <section id="backoffice" className="py-20 bg-gray-100">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto mb-12">
          {/* Dashboard Preview Image - Exact URL from DentCall */}
          <img 
